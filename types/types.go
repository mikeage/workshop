...
//User represents the user data structure for ther user collection
type User struct {
...
//Loan represents the loan data structre for the user
type Loan struct {
...
//Marshal marshals data and throws out the error
